...
Cấu hình Galera tại node db-nc-1, tạo một tệp trong thư mục `/etc/mysql/conf.d/galera.cnf`. Thêm nội dung sau vào tệp:
...
Cấu hình Galera tại node db-nc-2, tạo một tệp trong thư mục `/etc/mysql/conf.d/galera.cnf`. Thêm nội dung sau vào tệp:
...
Cấu hình Galera tại node db-nc-3, tạo một tệp trong thư mục `/etc/mysql/conf.d/galera.cnf`. Thêm nội dung sau vào tệp:
