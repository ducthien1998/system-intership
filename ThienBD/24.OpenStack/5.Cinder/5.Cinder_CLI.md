...
# 4. Attach và detach volume máy ảo 
...
ví dụ:
```
openstack server remove volume vm01-cirros vlm_thienbd
```
...
Để resize volume (đã ở trạng thái avalable ): Size của volume resize phải lớn hơn size ban đầu 
...
[1] [https://docs.openstack.org/cinder/train/cli/cli-manage-volumes.html](https://docs.openstack.org/cinder/train/cli/cli-manage-volumes.html)
[2] [https://docs.openstack.org/python-openstackclient/latest/cli/command-objects/volume-snapshot.html](https://docs.openstack.org/python-openstackclient/latest/cli/command-objects/volume-snapshot.html)