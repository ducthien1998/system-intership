...
# 1. Tổng quan về dịch vụ mạng của OPS
...
- Neutron API hỗ trợ Layer2 networking và IP address management (IPAM - quản lý địa chỉ IP)
...
# 3. Các loại mạng trong Openstack Networking
