...
**3. Fernet Token**
- Fernet là loại token nhẹ và an toàn, sử dụng mã hóa đối xứng để tạo và xác thực token. Token Fernet chứa thông tin cơ bản và được mã hóa để giảm kích thước.
